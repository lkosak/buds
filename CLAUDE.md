...
## Build & test locally
- Build and run on simulator: `xcodebuild -scheme Buds -destination 'platform=iOS Simulator,id=<UDID>'`
- Use `xcrun simctl launch --console <UDID> io.lou.app` to capture crash logs
